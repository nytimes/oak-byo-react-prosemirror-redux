...
- Make a new directory (you can call it whatever you like, I called it
  `build-your-own-redux`)
- `cd` into it
- Copy the contents of the files below (`index.js` and `index.html`) into your
  new directory
- Run `python3 -m http.server 9030` to run a web server
- Access your tiny web application at `http://localhost:9030` in your web
  browser!
